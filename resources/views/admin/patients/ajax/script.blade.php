<script>
    ...
    $(document).ready(function () {
      $(document).on('click', '.show-ajax', function () {
        $.ajax({
            url:  '{{aurl("")}}/patients/' + $(this).data('ajax'),
            type: 'get',
            success: function (data) {
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit-ajax', function () {
            ...
            $.ajax({
                url:  '{{aurl("")}}/patients/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function(){  
        $(document).on('submit', '#update_form', function(event){
            ...
            $.ajax({
                url: '{{aurl("")}}/patients/' + $('#ajax_edit_content #id').val() + '/update',
                method:"post",
                data: new FormData(this),
                contentType: false,
                cache:false,
    ...
    function clearFields() {
        ...
        $('#ajax_create_content #date_of_birth').val('');

<script>
    ...
    $(document).ready(function(){   
        ...
        $('#store_form').on('submit', function(event){
            ...
            $.ajax({
                url:"{{route('sub-specialists.store')}}",
                method:"POST",
    ...
    $(document).ready(function () {
      $(document).on('click', '.show-ajax', function () {
        $.ajax({
            url:  '{{aurl("")}}/sub-specialists/' + $(this).data('ajax'),
            type: 'get',
            success: function (data) {
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit-ajax', function () {
            ...
            $.ajax({
                url:  '{{aurl("")}}/sub-specialists/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function () {
        $(document).on('click', '#ajax_delete_all', function () {
            ...
            $.ajax({
                url:  '{{route('subspecialists.destroyAll')}}',
                type: 'delete',
                data: {

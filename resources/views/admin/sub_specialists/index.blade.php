@extends('admin.index')
@section('pageTitle', trans('admin.subspecialists'))
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="ajax_create_content">
            ...
            {!! Form::open(['id' => 'store_form']) !!}
                ...
                <div class="form-group">
                    {!! Form::select('spec_id', App\Models\Specialist::pluck('name_'.session('lang'), 'id'), old(session('lang').'_name'), ['placeholder' => trans('admin.specialist')  , 'class' => 'form-control']) !!}
                </div>
...
@include('admin.sub_specialists.ajax.script')

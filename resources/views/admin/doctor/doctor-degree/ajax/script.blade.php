<script>
    ...
    $(document).ready(function () {
        $(document).on('click', '.show-ajax', function () {
            $.ajax({
                url:  '{{aurl("")}}/doctor-degree/' + $(this).data('ajax'),
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit-ajax', function () {
            ...
            $.ajax({
                url:  '{{aurl("")}}/doctor-degree/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function(){
        $(document).on('submit', '#update_form', function(event){
            ...
            $.ajax({
                url: '{{aurl("")}}/doctor-degree/' + $('#ajax_edit_content #id').val() + '/update',
                method:"post",
                data: new FormData(this),
                contentType: false,
                cache:false,
    ...
    $(document).ready(function () {
        $(document).on('click', '#ajax_delete_all', function () {
            ...
            $.ajax({
                url:  '{{route('doctor-degree.destroyAll')}}',
                type: 'delete',
                data: {
    ...
    function clearFields() {
        ...
        $('#ajax_create_content #description').val('');

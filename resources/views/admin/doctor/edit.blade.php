        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group subspecdiv">
                    ...
                    {!! Form::select('subspec_id[]', App\Models\SubSpecialist::where('id', $doctor->spec_id)->pluck('name_'.session('lang'), 'id'), $doctor->subspecialists, ['multiple' => 'multiple','class' => 'form-control subspec', 'data-strength' => '']) !!}
                </div>

<script>
    ...
    $(document).ready(function(){
        ...
        $('#store_form').on('submit', function(event){
            ...
            $.ajax({
                url:"{{route('doctor-addresses.store')}}",
                method:"POST",
    ...
    $(document).ready(function () {
        $(document).on('click', '.show-ajax', function () {
            $.ajax({
                url:  '{{aurl("")}}/doctor-addresses/' + $(this).data('ajax'),
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function () {
        $(document).on('click', '.edit-ajax', function () {
            ...
            $.ajax({
                url:  '{{aurl("")}}/doctor-addresses/' + $(this).data('ajax') + '/edit',
                type: 'get',
                success: function (data) {
    ...
    $(document).ready(function(){
        $(document).on('submit', '#update_form', function(event){
            ...
            $.ajax({
                url: '{{aurl("")}}/doctor-addresses/' + $('#ajax_edit_content #id').val() + '/update',
                method:"post",
                data: new FormData(this),
                contentType: false,
                cache:false,
    ...
    $(document).ready(function () {
        $(document).on('click', '#ajax_delete_all', function () {
            ...
            $.ajax({
                url:  '{{route('doctor-addresses.destroyAll')}}',
                type: 'delete',
                data: {
    ...
    function clearFields() {
        $('#ajax_create_content #address_en').val('');
        $('#ajax_create_content #address_ar').val('');
